...
export default function CarRentalLoginScreen() {
  ...
  return (
    <div
  className="flex flex-col font-jakarta items-center justify-center min-h-screen p-4 text-white  bg-custom-login-gradient"
>
    ...
    border-[5px] border-[#383838]
    w-[200px]' />
            <h2 className="text-xl font-bold mb-4 text-white">Car Agent</h2>
           <Button title="Login" rounded='rounded-[35px]' textColor='text-black'  bgColor='bg-white'/>
          </div>
        </BaseCard>
