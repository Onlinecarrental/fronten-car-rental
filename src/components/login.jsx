      ...
      <div className="w-full max-w-4xl rounded-3xl shadow-2xl overflow-hidden backdrop-blur-lg bg-white/80 border border-[#5937E0]/20">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 flex flex-col justify-center items-center relative overflow-hidden bg-gradient-to-br from-[#a9a9a9] via-[#ffffff] to-[#5937E0] p-8 lg:p-12">
            {/* Modern background pattern with requested colors */}
          ...
          <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center bg-white/80 backdrop-blur-xl">
            <div className="max-w-md mx-auto w-full">
              ...
              <form onSubmit={handleLogin} className="space-y-7">
                <div>
                  <label className="block text-sm font-semibold text-[#5937E0] mb-2">
                    Email Address
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <svg className="h-5 w-5 text-[#5937E0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border border-[#5937E0]/30 rounded-xl focus:ring-2 focus:ring-[#5937E0] focus:border-transparent transition duration-200 bg-white/90 text-[#000000] font-medium shadow-sm"
                      value={email}
